...
def RA(k):
    ...
    #target_lst_2=datetime.datetime.strptime(target_lst_str, '%H:%M:%S.%fffffff')
    
    target_lst = Angle(target_lst_str, unit='hour')

    total_seconds = target_lst.hour * 3600
    ...
    return ra_datetime, seconds_to_wait
